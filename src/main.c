    ...
    while (first) {
        ...
        while (second) {
            ...
            if (check_for_exist(ans, answers) == 0
                ...
                way = 0;
            } else if (check_for_exist(ans, answers) == 1
            	|| !strcmp(ans, answers[7])) {
                command_for_search(g, start, end, ways, &way);
                printf("\n");
                print_longest_way(g, ways, way, end);
                way = 0;
            } else if (check_for_exist(ans, answers) == 2
            	|| !strcmp(ans, answers[8])) {
                command_for_search(g, start, end, ways, &way);
                printf("\n");
                print_all_ways(g, ways, way, end);
                way = 0;
            } else if (check_for_exist(ans, answers) == 3
                ...
                print_longest_way(g, ways, way, end);
                way = 0;
            } else if (check_for_exist(ans, answers) == 4
            	|| !strcmp(ans, answers[10])) {
                second = 0;
            } else if (check_for_exist(ans, answers) == 5
