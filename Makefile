...
bin/task_on_graph: build/src/main.o build/src/scanftown.o build/src/graph.o build/src/find_and_print_all_ways.o
	gcc -Wall -o bin/task_on_graph build/src/main.o build/src/scanftown.o build/src/graph.o build/src/find_and_print_all_ways.o -lm
